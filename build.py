...
<link rel="icon" href="favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="style-header-art.css"><script type="application/ld+json">{json.dumps(schema,ensure_ascii=False).replace('<','&#60;')}</script></head>
<body><a class="skip" href="#main">本文へ移動</a><div class="wrap"><header><img class="header-character" src="header-title-art.png" alt="" aria-hidden="true"><a class="brand" href="./">ちび猫ちゃん<span aria-hidden="true">🐾</span></a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="main-menu"><span class="menu-icon" aria-hidden="true"></span><span class="sr-only">メニューを開く</span></button><nav id="main-menu" aria-label="メインメニュー"><a href="#about">ちび猫ちゃん</a><a href="#charm">きゅん</a>{'<a href="#social">あいにいく</a>' if socials else ''}</nav></header>
</div><main id="main"><div class="wrap"><section class="hero {'text-only' if not image else ''}"><div><p class="eyebrow">OFFICIAL WEBSITE</p><h1>ちび猫ちゃん🐾</h1><p class="english">CHIBI NEKOCHAN</p><p class="intro">ちいさな、ねこちゃんのような女の子。<br>いつも一緒にいたくなる、<br>やさしくて甘えんぼうなマスコット。</p></div>{portrait}</section></div>
