...
<link rel="icon" href="favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="style-mobile.css"><script type="application/ld+json">{json.dumps(schema,ensure_ascii=False).replace('<','&#60;')}</script></head>
<body><a class="skip" href="#main">本文へ移動</a><div class="wrap"><header><a class="brand" href="./">ちび猫ちゃん</a><nav aria-label="メインメニュー"><a href="#about">紹介</a><a href="#charm">魅力</a>{'<a href="#social">SNS</a>' if socials else ''}</nav></header>
...
<section class="about" id="about"><div class="wrap section-grid"><div><p class="eyebrow">ABOUT</p><h2>ちび猫ちゃんについて</h2></div><div><p class="about-lead">手のひらに、ちょこん。</p><p>ちび猫ちゃんは、身長約12cmのオリジナルキャラクター。<br>銀青のボブと白いねこ耳、きらきらした青い瞳が目印です。</p><p>大きな胸リボンに、白いフリルのピンクのワンピース。<br>青いしっぽと、はだしの小さな足もチャームポイント。</p><dl class="profile"><div><dt>サイズ</dt><dd>約12cm・手のひらサイズ</dd></div><div><dt>性格</dt><dd>やさしくて甘えんぼう</dd></div></dl></div></div></section><section class="charm wrap" id="charm"><div class="charm-heading"><p class="eyebrow">LITTLE MOMENTS</p><h2>ちいさな表情に、きゅん。</h2><p>にっこりしたり、びっくりしたり。<br>どんな顔も、そばで見ていたくなる。</p></div><div class="charm-grid"><article class="charm-card"><img src="smile.png" width="1024" height="1024" alt="目を細めてにっこり笑うちび猫ちゃん" loading="lazy"><div class="charm-copy"><span class="moment">01 / SMILE</span><h3>つられて、にっこり。</h3><p>目をきゅっと細めた、うれしい笑顔。<br>見ているこっちまで、ほっぺがゆるむ。</p></div></article><article class="charm-card"><img src="surprise.png" width="1024" height="1024" alt="青い瞳をまんまるにしてびっくりするちび猫ちゃん" loading="lazy"><div class="charm-copy"><span class="moment">02 / SURPRISE</span><h3>あれっ？ なあに？</h3><p>まんまるな青い瞳に、小さなおくち。<br>びっくりした顔にも、きゅん。</p></div></article><article class="charm-card"><img src="palms.png" width="1024" height="1024" alt="両手のひらにちょこんと座る小さなちび猫ちゃん" loading="lazy"><div class="charm-copy"><span class="moment">03 / TOGETHER</span><h3>この手のひらが、特等席。</h3><p>約12cmの、ちいさなちいさな存在。<br>そっと包んで、ずっと一緒に。</p></div></article></div></section>{social_section}</main>
