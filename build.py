...
social_section = f'<section class="social wrap" id="social"><p class="eyebrow">FOLLOW</p><p class="social-main">ちび猫ちゃんに、会いにきてね。</p><div class="social-links">{links}</div><p class="social-note">ちび猫ちゃんは、たまごぼーろのSNSで活躍中。</p></section>' if socials else ''
...
<link rel="icon" href="favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="style-menu-all.css"><script type="application/ld+json">{json.dumps(schema,ensure_ascii=False).replace('<','&#60;')}</script></head>
